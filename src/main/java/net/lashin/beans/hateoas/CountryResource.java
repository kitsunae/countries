...
public class CountryResource extends ResourceSupport {
    ...
    public Country toCountry(){
        Country country = new Country(code, name, continent, region, surfaceArea, indepYear, population, lifeExpectancy, gnp, gnpOld, localName, governmentForm, headOfState, code2);
